        ...
        <div class="home-background vh-100">
            <div class="row header px-5 m-0">
                <div class="d-flex col-8 align-items-center">
                    <img src="{{ asset('/frontend/images/netflix.png') }}" alt="Logo" width="100" class="me-4" />
                    <ul class="d-flex m-0">
                ...
                <div class="d-flex col-4 align-items-center justify-content-end">
                    <div class="header-icon">
                        <a href="./search.html"><img src="{{ asset('/frontend/icon/icons8-search-50.png') }}" alt="search-icon"
                                width="20" height="20" /></a>
                    </div>
                    <div class="header-icon ms-3">
                        <a href="./profile.html">
                            <img src="{{ asset('/frontend/icon/icons8-person-50.png') }}" alt="person-icon" width="20"
                                height="20" />
                        </a>
                    </div>
                    <div class="header-icon ms-3">
                        <a href="./signin.html">
                            <img src="{{ asset('/frontend/icon/icons8-log-out-26.png') }}" alt="logout-icon" width="20"
                                height="20" />
                        </a>
                    </div>
                </div>
            ...
            <div class="row px-5 content-title me-0">
                ...
                <div class="d-flex">
                    <button class="btn btn-play col-1 d-flex align-items-center justify-content-center me-3">
                        <img src="{{ asset('/frontend/icon/icons8-play-24.png" alt="icon-play') }}" />
                        <p class="text-white p-0 m-0">Play</p>
                    </button>
                    <button class="btn btn-mute col- d-flex align-items-center justify-content-center">
                        <img src="{{ asset('/frontend/icon/icons8-mute-24.png') }}" alt="icon-mute" />
                    </button>
                </div>
            </div>
        </div>
